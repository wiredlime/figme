...
export const NewThread = ({ children }: Props) => {
  ...
  // get the max z-index of a thread, to show the latest comment
  ...
  // Open or close the composer correspond to the creatingCommentState
  useEffect(() => {
  ...
  // Update the composer position to correspond with the pointer
  useEffect(() => {
  ...
  const handleComposerSubmit = useCallback(
    ({ body }: ComposerSubmitComment, event: FormEvent<HTMLFormElement>) => {
      ...
      //Clean up after creating new thread
